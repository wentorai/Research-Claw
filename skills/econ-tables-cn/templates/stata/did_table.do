* Stata table template: did_table.do for econ-tables-cn
clear
set more off
version 17
...
* expected keywords: reghdfe esttab
* reghdfe y treat_post control, absorb(firm_id year) vce(cluster firm_id)
esttab, se
