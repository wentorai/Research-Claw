* Stata table template: clustered_se.do for econ-tables-cn
clear
set more off
version 17
...
* expected keywords: esttab vce(cluster reghdfe
* reghdfe y x control, absorb(year) vce(cluster firm_id)
esttab, se
