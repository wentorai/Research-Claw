* Stata table template: multi_model.do for econ-tables-cn
clear
set more off
version 17
...
* expected keywords: esttab eststo reghdfe
eststo clear
* reghdfe y x control, absorb(firm_id year) vce(cluster firm_id)
eststo: regress y x control
esttab, se
